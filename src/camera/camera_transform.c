...
/*   Updated: 2022/05/05 07:41:43 by cdiaz-fl         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_ray	ray_for_pixel(t_camera *cam, double px, double py)
{
	...
	invert = invert_mtx(&cam->transform);
	pixel_pt = mul_point_mtx(&invert, world_pt);
	ray.origin = mul_point_mtx(&invert, create_point(0, 0, 0));
